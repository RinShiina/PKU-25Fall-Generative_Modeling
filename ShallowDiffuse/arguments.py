...
def parse_args():
    ...
    parser.add_argument('--vae_attack_model_name', default='bmshj2018-hyperprior') # 原有的
    
    # === 新增这两行 ===
    parser.add_argument('--vae_attack_model_name1', default='bmshj2018_factorized') 
    parser.add_argument('--vae_attack_model_name2', default='bmshj2018_hyperprior')
    # =================
    # hyperparameters
    parser.add_argument('--edit_time_list', required=True, type=list_of_floats) # The timestep to embed the watermark.

    args = parser.parse_args()
    parser.add_argument('--median_blur', default=3, type=int) # 补全缺失的参数
    return args
